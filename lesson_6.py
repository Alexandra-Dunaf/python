...
class Worker:
    ...
    def __init__(self, name='Ivan', surname='Ivanov', position='driver', wage=100, bonus=20):
        self.name = name
...
v_pet = Position('Ivan', 'Ivanov', 'driver', 110, 30)
